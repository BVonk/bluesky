...
# Path to weights and episodes

if __name__ == '__main__':
    folder = "20190130_113101-3.6"
    path = "C:/Users/Bart/Documents/bluesky/output/" + folder
    for episode in np.arange(100,2050, 100):
        for offset in [-10, 0, 10]:
            out = "E:\\OneDrive\\Documenten\\TU\\Thesis\\Thesis\\figures\\heatmaps\\heatmap_{}_{}.png".format(episode, offset)
            actions = heatmap(path, episode, out, offset)
